...
username arista ssh-key ssh-rsa  arista@automationws-10-d11569ec-eos
```
...
| --------- | --------------- | ------------ | --------- |
| S2_BRDR | Vlan4094 | 10.251.2.8 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_s2-brdr1_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet6 | MLAG_s2-brdr1_Ethernet6 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_s2-spine1_Ethernet8 | - | 172.16.2.21/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_s2-spine2_Ethernet8 | - | 172.16.2.23/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_s1-brdr2_Ethernet5 | - | 172.16.255.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet5
   description P2P_s1-brdr2_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_s2-brdr1_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.250.2.8/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.255.2.7/32 |
...
| Vlan3009 |  OVERLAY  |  10.252.2.9/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.252.2.9/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.251.2.9/31  |  -  |  -  |  -  |  -  |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.250.2.8:10010 | 10010:10010 | - | - | learned |
| 20 | 10.250.2.8:10020 | 10020:10020 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| OVERLAY | 10.250.2.8:10 | connected |
...
router bgp 65203
   ...
   neighbor 172.16.2.20 description s2-spine1_Ethernet8
   ...
   vrf OVERLAY
      ...
      router-id 10.250.2.8
      neighbor 10.252.2.8 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.2.8 description s2-brdr1_Vlan3009
