...
| 10.252.2.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | OVERLAY | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| OVERLAY | 10.250.2.5:10 | connected |
